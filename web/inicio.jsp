<%-- 
    Document   : inicio
    Created on : 28-ago-2019, 19:53:46
    Author     : sebas
--%>
...
<html>
    ...
    <body>
        <div class="container">
      <h1 class="text-center mt-5 text-success">Welcome</h1>
                ...
                <div class="col-12 col-md-12 offset-lg-4 col-lg-4">
                    <div class="container mt-3 p-4">
                      <div style="display: flex; align-items: center;">
                        <a href="reportesEstudiante.jsp">Data Estudiantes</a><br><hr>
                        <a href="reportesProfesores.jsp">Data profesores</a>
                      </div>
                    </div>
                </div>
              </div>
